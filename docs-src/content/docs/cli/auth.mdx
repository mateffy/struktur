---
title: auth
description: Manage API tokens for providers.
---

# auth

Manage API tokens for providers.
...
- [Installation & Setup](./installation) — initial setup
- [Environment Variables](./environment) — env vars