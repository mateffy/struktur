...
| `--fields <string>` | `-f` | string | [Fields shorthand](./fields) — comma-separated field definitions. |

`--fields` is the quickest way to define a schema without writing JSON. See [--fields reference](./fields) for the full syntax.
...
- [--fields reference](./fields) — fields shorthand syntax and examples
