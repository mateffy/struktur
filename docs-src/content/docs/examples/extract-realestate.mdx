...
# Extract Real Estate Listings How-to

Extract property details and images from PDF exposés.
...
- [sequentialAutoMerge](../explanation/strategies/sequential-auto-merge) — strategy reference
- [Choosing a Strategy](../explanation/strategies/choosing) — decision guide
- [The Artifact Format](../explanation/preprocessing/artifact-format) — handling images
