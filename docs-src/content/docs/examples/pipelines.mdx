...
- [extract](../cli/extract) — CLI flags
- [Process a Directory of Files](./process-directory) — detailed example
- [Watch a Folder for New Files](./watch-folder) — detailed example
