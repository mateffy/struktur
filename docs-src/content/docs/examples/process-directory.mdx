...
# Process a Directory of Files How-to
...
- [Watch a Folder for New Files](./watch-folder) — continuous processing
- [parallelAutoMerge](../explanation/strategies/parallel-auto-merge) — parallel strategy
