...
- [The Extraction Pipeline](./pipeline) — the full flow
- [Strategies](./strategies) — which strategies use chunking
- [parallel](./strategies/parallel) — chunked parallel extraction
- [sequential](./strategies/sequential) — chunked sequential extraction
