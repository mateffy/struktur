...
# Why Struktur Does Not Parse Files

The design decision behind Struktur's focus on extraction, not parsing.
...
- [The Artifact Format](./artifact-format) — the input contract
- [Built-in Input Types](./built-in-inputs) — how to get data into Struktur
