...
description: Build JSON schemas on the fly with a simple comma-separated string instead of writing full JSON Schema objects.
---
...
- [extract()](./extract) — full option reference
- [CLI `--fields`](../cli/fields) — using fields from the command line
