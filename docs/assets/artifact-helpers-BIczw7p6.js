import{j as i}from"./main-lZB4Rnhx.js";let a=`
...
`,r={title:"Artifact Helpers",description:"Functions to create artifacts from various sources."},l={contents:[{heading:"parseinputtoartifactsinput-options",content:"The primary way to load files and text into artifacts. Handles MIME detection, parser resolution, and PDF image extraction automatically."},{heading:"parseinputtoartifactsinput-options",content:"Supported input kinds:"},{heading:"parseinputtoartifactsinput-options",content:"Input kind"},{heading:"parseinputtoartifactsinput-options",content:"Description"},{heading:"parseinputtoartifactsinput-options",content:'`{ kind: "text", text }`'},{heading:"parseinputtoartifactsinput-options",content:"Text artifact (split on double newlines)"},{heading:"parseinputtoartifactsinput-options",content:'`{ kind: "file", path, mimeType? }`'},{heading:"parseinputtoartifactsinput-options",content:"File artifact — MIME auto-detected, parser resolved from `parserConfig` then built-ins"},{heading:"parseinputtoartifactsinput-options",content:'`{ kind: "buffer", buffer, mimeType }`'},{heading:"parseinputtoartifactsinput-options",content:"Buffer artifact — parser resolved from `parserConfig` then built-ins"},{heading:"parseinputtoartifactsinput-options",content:'`{ kind: "artifact-json", data }`'},{heading:"parseinputtoartifactsinput-options",content:"Validates and hydrates pre-built artifact JSON"},{heading:"filetoartifactbuffer-options",content:"Lower-level helper that creates an artifact from a Buffer using the `providers` registry."},{heading:"filetoartifactbuffer-options",content:"**Important:** `fileToArtifact` does **not** invoke the parser system. It uses the `providers` registry (a `Record<string, (buffer: Buffer) => Promise<Artifact>>`), which does not include the built-in PDF parser or any parsers configured via `config parsers add`. For PDF and other format support, use `parseInputToArtifacts` instead."},{heading:"filetoartifactbuffer-options",content:"If no provider is registered for the MIME type:"},{heading:"filetoartifactbuffer-options",content:"`text/*` → text artifact (split on double newlines)"},{heading:"filetoartifactbuffer-options",content:"`image/*` → image artifact (single media slice)"},{heading:"filetoartifactbuffer-options",content:"Anything else → throws `Unsupported MIME type`"},{heading:"urltoartifacturl",content:"Fetches a URL and expects it to return pre-serialized artifact JSON. Validates and hydrates."},{heading:"parseserializedartifactstext",content:"Parses a JSON string into artifacts with Ajv validation."},{heading:"validateserializedartifactsdata",content:"Validates an already-parsed value against the artifact schema."},{heading:"hydrateserializedartifactsitems",content:"Adds the `raw()` function to serialized artifacts."},{heading:"splittextintocontentstext",content:"Splits a text string on double newlines into content slices."},{heading:"see-also",content:"The Artifact Format — JSON spec"},{heading:"see-also",content:"Built-in Input Types — CLI input methods"},{heading:"see-also",content:"Parsers — how files are converted to artifacts"},{heading:"see-also",content:"Custom Provider — extending the provider registry"}],headings:[{id:"parseinputtoartifactsinput-options",content:"parseInputToArtifacts(input, options?)"},{id:"filetoartifactbuffer-options",content:"fileToArtifact(buffer, options)"},{id:"urltoartifacturl",content:"urlToArtifact(url)"},{id:"parseserializedartifactstext",content:"parseSerializedArtifacts(text)"},{id:"validateserializedartifactsdata",content:"validateSerializedArtifacts(data)"},{id:"hydrateserializedartifactsitems",content:"hydrateSerializedArtifacts(items)"},{id:"splittextintocontentstext",content:"splitTextIntoContents(text)"},{id:"see-also",content:"See also"}]};const h=[{depth:2,url:"#parseinputtoartifactsinput-options",title:i.jsx(i.Fragment,{children:"parseInputToArtifacts(input, options?)"})},{depth:2,url:"#filetoartifactbuffer-options",title:i.jsx(i.Fragment,{children:"fileToArtifact(buffer, options)"})},{depth:2,url:"#urltoartifacturl",title:i.jsx(i.Fragment,{children:"urlToArtifact(url)"})},{depth:2,url:"#parseserializedartifactstext",title:i.jsx(i.Fragment,{children:"parseSerializedArtifacts(text)"})},{depth:2,url:"#validateserializedartifactsdata",title:i.jsx(i.Fragment,{children:"validateSerializedArtifacts(data)"})},{depth:2,url:"#hydrateserializedartifactsitems",title:i.jsx(i.Fragment,{children:"hydrateSerializedArtifacts(items)"})},{depth:2,url:"#splittextintocontentstext",title:i.jsx(i.Fragment,{children:"splitTextIntoContents(text)"})},{depth:2,url:"#see-also",title:i.jsx(i.Fragment,{children:"See also"})}];function s(e){const t={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...e.components};return i.jsxs(i.Fragment,{children:[i.jsx(t.h2,{id:"parseinputtoartifactsinput-options",children:"parseInputToArtifacts(input, options?)"}),`
`,i.jsx(t.p,{children:"The primary way to load files and text into artifacts. Handles MIME detection, parser resolution, and PDF image extraction automatically."}),`
`,i.jsx(i.Fragment,{children:i.jsx(t.pre,{className:"shiki shiki-themes github-light github-dark",style:{"--shiki-light":"#24292e","--shiki-dark":"#e1e4e8","--shiki-light-bg":"#fff","--shiki-dark-bg":"#24292e"},tabIndex:"0",icon:'<svg viewBox="0 0 24 24"><path d="M1.125 0C.502 0 0 .502 0 1.125v21.75C0 23.498.502 24 1.125 24h21.75c.623 0 1.125-.502 1.125-1.125V1.125C24 .502 23.498 0 22.875 0zm17.363 9.75c.612 0 1.154.037 1.627.111a6.38 6.38 0 0 1 1.306.34v2.458a3.95 3.95 0 0 0-.643-.361 5.093 5.093 0 0 0-.717-.26 5.453 5.453 0 0 0-1.426-.2c-.3 0-.573.028-.819.086a2.1 2.1 0 0 0-.623.242c-.17.104-.3.229-.393.374a.888.888 0 0 0-.14.49c0 .196.053.373.156.529.104.156.252.304.443.444s.423.276.696.41c.273.135.582.274.926.416.47.197.892.407 1.266.628.374.222.695.473.963.753.268.279.472.598.614.957.142.359.214.776.214 1.253 0 .657-.125 1.21-.373 1.656a3.033 3.033 0 0 1-1.012 1.085 4.38 4.38 0 0 1-1.487.596c-.566.12-1.163.18-1.79.18a9.916 9.916 0 0 1-1.84-.164 5.544 5.544 0 0 1-1.512-.493v-2.63a5.033 5.033 0 0 0 3.237 1.2c.333 0 .624-.03.872-.09.249-.06.456-.144.623-.25.166-.108.29-.234.373-.38a1.023 1.023 0 0 0-.074-1.089 2.12 2.12 0 0 0-.537-.5 5.597 5.597 0 0 0-.807-.444 27.72 27.72 0 0 0-1.007-.436c-.918-.383-1.602-.852-2.053-1.405-.45-.553-.676-1.222-.676-2.005 0-.614.123-1.141.369-1.582.246-.441.58-.804 1.004-1.089a4.494 4.494 0 0 1 1.47-.629 7.536 7.536 0 0 1 1.77-.201zm-15.113.188h9.563v2.166H9.506v9.646H6.789v-9.646H3.375z" fill="currentColor" /></svg>',children:i.jsxs(t.code,{children:[i.jsxs(t.span,{className:"line",children:[i.jsx(t.span,{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"},children:"import"}),i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:" { parseInputToArtifacts } "}),i.jsx(t.span,{style:{"--shiki-light":"#D73A49","--shiki-dark":"#F97583"},children:"from"}),i.jsx(t.span,{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"},children:' "@mateffy/struktur"'}),i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:";"})]}),`
...
`,i.jsxs(t.span,{className:"line",children:[i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"    parserConfig: parsersConfig,   "}),i.jsx(t.span,{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"},children:"// ParsersConfig — keyed by MIME type"})]}),`
`,i.jsxs(t.span,{className:"line",children:[i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"    includeImages: "}),i.jsx(t.span,{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"},children:"true"}),i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:",           "}),i.jsx(t.span,{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"},children:"// extract embedded PDF images"})]}),`
`,i.jsxs(t.span,{className:"line",children:[i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"    screenshots: "}),i.jsx(t.span,{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"},children:"false"}),i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:",            "}),i.jsx(t.span,{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"},children:"// render PDF page screenshots"})]}),`
`,i.jsxs(t.span,{className:"line",children:[i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"    screenshotScale: "}),i.jsx(t.span,{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"},children:"1.5"}),i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:",          "}),i.jsx(t.span,{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"},children:"// scale factor for screenshots"})]}),`
`,i.jsxs(t.span,{className:"line",children:[i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"    screenshotWidth: "}),i.jsx(t.span,{style:{"--shiki-light":"#005CC5","--shiki-dark":"#79B8FF"},children:"undefined"}),i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:",    "}),i.jsx(t.span,{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"},children:"// target width in pixels (overrides screenshotScale)"})]}),`
`,i.jsx(t.span,{className:"line",children:i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"  }"})}),`
`,i.jsx(t.span,{className:"line",children:i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:");"})})]})})}),`
`,i.jsx(t.p,{children:"Supported input kinds:"}),`
`,i.jsxs(t.table,{children:[i.jsx(t.thead,{children:i.jsxs(t.tr,{children:[i.jsx(t.th,{children:"Input kind"}),i.jsx(t.th,{children:"Description"})]})}),i.jsxs(t.tbody,{children:[i.jsxs(t.tr,{children:[i.jsx(t.td,{children:i.jsx(t.code,{children:'{ kind: "text", text }'})}),i.jsx(t.td,{children:"Text artifact (split on double newlines)"})]}),i.jsxs(t.tr,{children:[i.jsx(t.td,{children:i.jsx(t.code,{children:'{ kind: "file", path, mimeType? }'})}),i.jsxs(t.td,{children:["File artifact — MIME auto-detected, parser resolved from ",i.jsx(t.code,{children:"parserConfig"})," then built-ins"]})]}),i.jsxs(t.tr,{children:[i.jsx(t.td,{children:i.jsx(t.code,{children:'{ kind: "buffer", buffer, mimeType }'})}),i.jsxs(t.td,{children:["Buffer artifact — parser resolved from ",i.jsx(t.code,{children:"parserConfig"})," then built-ins"]})]}),i.jsxs(t.tr,{children:[i.jsx(t.td,{children:i.jsx(t.code,{children:'{ kind: "artifact-json", data }'})}),i.jsx(t.td,{children:"Validates and hydrates pre-built artifact JSON"})]})]})]}),`
`,i.jsx(t.h2,{id:"filetoartifactbuffer-options",children:"fileToArtifact(buffer, options)"}),`
`,i.jsxs(t.p,{children:["Lower-level helper that creates an artifact from a Buffer using the ",i.jsx(t.code,{children:"providers"})," registry."]}),`
`,i.jsxs(t.p,{children:[i.jsx(t.strong,{children:"Important:"})," ",i.jsx(t.code,{children:"fileToArtifact"})," does ",i.jsx(t.strong,{children:"not"})," invoke the parser system. It uses the ",i.jsx(t.code,{children:"providers"})," registry (a ",i.jsx(t.code,{children:"Record<string, (buffer: Buffer) => Promise<Artifact>>"}),"), which does not include the built-in PDF parser or any parsers configured via ",i.jsx(t.code,{children:"config parsers add"}),". For PDF and other format support, use ",i.jsx(t.code,{children:"parseInputToArtifacts"})," instead."]}),`
`,i.jsx(t.p,{children:"If no provider is registered for the MIME type:"}),`
`,i.jsxs(t.ul,{children:[`
`,i.jsxs(t.li,{children:[i.jsx(t.code,{children:"text/*"})," → text artifact (split on double newlines)"]}),`
`,i.jsxs(t.li,{children:[i.jsx(t.code,{children:"image/*"})," → image artifact (single media slice)"]}),`
...
`,i.jsxs(t.span,{className:"line",children:[i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"  mimeType: "}),i.jsx(t.span,{style:{"--shiki-light":"#032F62","--shiki-dark":"#9ECBFF"},children:'"text/plain"'}),i.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:","})]}),`
...
`,i.jsxs(t.li,{children:[i.jsx(t.a,{href:"/docs/explanation/parsers",children:"Parsers"})," — how files are converted to artifacts"]}),`
`,i.jsxs(t.li,{children:[i.jsx(t.a,{href:"/docs/explanation/preprocessing/custom-provider",children:"Custom Provider"})," — extending the provider registry"]}),`
`]})]})}function d(e={}){const{wrapper:t}=e.components||{};return t?i.jsx(t,{...e,children:i.jsx(s,{...e})}):s(e)}export{a as _markdown,d as default,r as frontmatter,l as structuredData,h as toc};
