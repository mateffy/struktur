import{j as e}from"./main-lZB4Rnhx.js";let i=`
...
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/docs/explanation/strategies",children:"Strategies"})," — which strategies use chunking"]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/docs/explanation/strategies/parallel",children:"parallel"})," — chunked parallel extraction"]}),`
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/docs/explanation/strategies/sequential",children:"sequential"})," — chunked sequential extraction"]}),`
`]})]})}function c(a={}){const{wrapper:t}=a.components||{};return t?e.jsx(t,{...a,children:e.jsx(n,{...a})}):n(a)}export{i as _markdown,c as default,r as frontmatter,l as structuredData,o as toc};
