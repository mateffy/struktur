...
`,i.jsxs(s.p,{children:[i.jsx(s.strong,{children:"npm parser"})," — install a package that implements the ",i.jsx(s.a,{href:"/docs/explanation/parsers#npm-parser-contract",children:"npm parser contract"}),":"]}),`
...
`,i.jsxs(s.li,{children:[i.jsx(s.a,{href:"/docs/cli/installation",children:"Installation & Setup"})," — initial setup"]}),`
`,i.jsxs(s.li,{children:[i.jsx(s.a,{href:"/docs/cli/environment",children:"Environment Variables"})," — env var alternatives to stored tokens"]}),`
`,i.jsxs(s.li,{children:[i.jsx(s.a,{href:"/docs/explanation/parsers",children:"Parsers"})," — how the parser system works"]}),`
