import{j as i}from"./main-PqBd4K9d.js";let l=`
...
`,i.jsxs(s.ul,{children:[`
`,i.jsxs(s.li,{children:[i.jsx(s.a,{href:"/docs/explanation/strategies/sequential-auto-merge",children:"sequentialAutoMerge"})," — strategy reference"]}),`
`,i.jsxs(s.li,{children:[i.jsx(s.a,{href:"/docs/explanation/strategies/choosing",children:"Choosing a Strategy"})," — decision guide"]}),`
`,i.jsxs(s.li,{children:[i.jsx(s.a,{href:"/docs/explanation/preprocessing/artifact-format",children:"The Artifact Format"})," — handling images"]}),`
