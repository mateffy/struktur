...
`,e.jsxs(i.p,{children:["Use ",e.jsx(i.code,{children:"array{itemType}"})," for array fields. The item type can be any scalar keyword including aliases."]}),`
...
`,e.jsx(i.span,{className:"line",children:e.jsx(i.span,{style:{"--shiki-light":"#6A737D","--shiki-dark":"#6A737D"},children:"//        Complex types: enum{a|b|c}, array{string}."})}),`
`,e.jsx(i.span,{className:"line"}),`
