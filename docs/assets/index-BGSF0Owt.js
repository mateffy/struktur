...
`,t.jsx(e.p,{children:"When you ask your AI agent to work with Struktur, the skill automatically loads and provides:"}),`
...
`,t.jsxs(e.ul,{children:[`
`,t.jsxs(e.li,{children:[t.jsx(e.a,{href:"/docs/skill/installation",children:"Installation Guide"})," — Install for your preferred tool"]}),`
`,t.jsxs(e.li,{children:[t.jsx(e.a,{href:"/docs/skill/usage",children:"Usage Examples"})," — How to use the skill with your AI agent"]}),`
`]})]})}function d(n={}){const{wrapper:e}=n.components||{};return e?t.jsx(e,{...n,children:t.jsx(s,{...n})}):s(n)}export{i as _markdown,d as default,o as frontmatter,a as structuredData,r as toc};
