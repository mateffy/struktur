import{j as i}from"./main-BiZqUaIh.js";let r=`
...
`,i.jsxs(n.ul,{children:[`
`,i.jsxs(n.li,{children:[i.jsx(n.a,{href:"/vs/llamaindex",children:"Struktur vs LlamaIndex"})," — Cloud vs self-hosted"]}),`
`,i.jsxs(n.li,{children:[i.jsx(n.a,{href:"/vs/unstract",children:"Struktur vs Unstract"})," — Open source platforms"]}),`
`,i.jsxs(n.li,{children:[i.jsx(n.a,{href:"/vs/manual-llm-calls",children:"Struktur vs Manual LLM Calls"})," — Building it yourself"]}),`
`]})]})}function c(s={}){const{wrapper:n}=s.components||{};return n?i.jsx(n,{...s,children:i.jsx(e,{...s})}):e(s)}export{r as _markdown,c as default,l as frontmatter,a as structuredData,h as toc};
