...
See [Artifacts](/docs/explanation/preprocessing/artifact-format) for the artifact concept.
...
* [Artifacts](/docs/explanation/preprocessing/artifact-format) — the input format
...
`,e.jsx(t.span,{className:"line",children:e.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"        C1[Chunking] --> C2[LLM Calls]"})}),`
`,e.jsx(t.span,{className:"line",children:e.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"        C2 --> C3[Validation + Retry]"})}),`
`,e.jsx(t.span,{className:"line",children:e.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"        C3 --> C4[Merge/Dedupe]"})}),`
`,e.jsx(t.span,{className:"line",children:e.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"    end"})}),`
`,e.jsx(t.span,{className:"line",children:e.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"    "})}),`
`,e.jsx(t.span,{className:"line",children:e.jsx(t.span,{style:{"--shiki-light":"#24292E","--shiki-dark":"#E1E4E8"},children:"    C --> StrategyInternals --> D"})})]})})}),`
`,e.jsx(t.h2,{id:"inputs-and-artifacts",children:"Inputs and Artifacts"}),`
`,e.jsxs(t.p,{children:["Struktur operates on ",e.jsx(t.strong,{children:"Artifacts"}),", not raw files. The boundary is intentional — you handle parsing (PDF → text, HTML → markdown), Struktur handles extraction. This keeps the tool focused and lets you use best-of-breed parsers per format."]}),`
`,e.jsxs(t.p,{children:["See ",e.jsx(t.a,{href:"/docs/explanation/preprocessing/artifact-format",children:"Artifacts"})," for the artifact concept."]}),`
...
`,e.jsxs(t.p,{children:["The validation loop is a key differentiator. Every LLM response is validated against the schema using Ajv ",e.jsx(t.strong,{children:"before"})," the strategy considers it done. If validation fails, the errors are serialized and sent back to the model as a follow-up message."]}),`
...
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/docs/explanation/preprocessing/artifact-format",children:"Artifacts"})," — the input format"]}),`
