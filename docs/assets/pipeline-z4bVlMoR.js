...
See [Parsers](/docs/explanation/parsers) for how files are converted to artifacts.
...
`,e.jsxs(t.p,{children:["See ",e.jsx(t.a,{href:"/docs/explanation/parsers",children:"Parsers"}),` for how files are converted to artifacts.
See `,e.jsx(t.a,{href:"/docs/explanation/preprocessing/artifact-format",children:"Artifact Format"})," for the data structure."]}),`
...
`,e.jsxs(t.li,{children:[e.jsx(t.a,{href:"/docs/explanation/parsers",children:"Parsers"})," — how files are converted to artifacts"]}),`
...
`]})]})}function h(s={}){const{wrapper:t}=s.components||{};return t?e.jsx(t,{...s,children:e.jsx(n,{...s})}):n(s)}export{a as _markdown,h as default,r as frontmatter,o as structuredData,l as toc};
