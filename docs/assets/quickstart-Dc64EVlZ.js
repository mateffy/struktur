import{j as e}from"./main-CqW1cql0.js";let a=`
...
`,l={title:"Quickstart",description:"Get started with Struktur in under 5 minutes. Extract structured data from any file."},r={contents:[{heading:void 0,content:"Extract structured data from any file in 3 commands. About 5 minutes."},{heading:"what-well-build",content:"We will extract structured invoice data from a PDF using the CLI."},{heading:"what-well-build",content:"Expected output:"},{heading:"prerequisites",content:"Node.js 18+ or Bun installed"},{heading:"prerequisites",content:"An API key from OpenAI, Anthropic, Google, OpenCode, or OpenRouter"},{heading:"step-1-install",content:"Verify:"},{heading:"step-1-install",content:"You should see the usage output."},{heading:"step-2-configure-your-api-key",content:"**Option A (quick, for testing):**"},{heading:"step-2-configure-your-api-key",content:"**Option B (secure, persisted):**"},{heading:"step-2-configure-your-api-key",content:'Output: `{ "provider": "openai", "stored": "keychain" }` (or `"file"` on Linux).'},{heading:"step-2-configure-your-api-key",content:"**Option C (one command, fully ready):**"},{heading:"step-2-configure-your-api-key",content:"The `--default` flag automatically queries the provider API and sets the cheapest available model as default, so `--model` becomes optional in all future commands."},{heading:"step-2b-set-a-default-model-optional",content:"If you didn't use `--default` above, set a default model explicitly:"},{heading:"step-2b-set-a-default-model-optional",content:"Once set, `--model` is optional in all `extract` commands."},{heading:"step-3-extract-your-first-data",content:"**From text:**"},{heading:"step-3-extract-your-first-data",content:"**From a PDF directly:**"},{heading:"step-3-extract-your-first-data",content:"The `--fields` flag builds a JSON Schema on the fly. Each field defaults to `string`; append `:number`, `:integer`, `:bool`, etc. to set the type. See --fields reference for the full syntax."},{heading:"step-3-extract-your-first-data",content:"If you need more control (optional fields, nested objects), pass a full schema instead:"},{heading:"step-3-extract-your-first-data",content:"Notice that `total` is a number, not a string — Struktur enforced the schema."},{heading:"what-happened",content:"For the text example, stdin input was loaded as an artifact, the LLM generated output, and Ajv validated it against your schema. The `simple` strategy handled this in a single LLM call."},{heading:"what-happened",content:"For the PDF example, an extra step happened first: the built-in PDF parser extracted text (and optionally images) from the file and converted it into an artifact, then extraction proceeded as normal. Add `--images` to include embedded images, or `--screenshots` to render page screenshots."},{heading:"what-happened",content:"To understand what happened inside, read The Extraction Pipeline."},{heading:"where-to-go-next",content:"Goal"},{heading:"where-to-go-next",content:"Link"},{heading:"where-to-go-next",content:"Keep learning"},{heading:"where-to-go-next",content:"The Extraction Pipeline"},{heading:"where-to-go-next",content:"Solve a real problem"},{heading:"where-to-go-next",content:"Extract Invoice Data"},{heading:"where-to-go-next",content:"Look up all CLI flags"},{heading:"where-to-go-next",content:"CLI Reference"},{heading:"where-to-go-next",content:"Use it in TypeScript"},{heading:"where-to-go-next",content:"TypeScript SDK"},{heading:"where-to-go-next",content:"Understand file parsing"},{heading:"where-to-go-next",content:"Parsers"}],headings:[{id:"what-well-build",content:"What we'll build"},{id:"prerequisites",content:"Prerequisites"},{id:"step-1-install",content:"Step 1: Install"},{id:"step-2-configure-your-api-key",content:"Step 2: Configure your API key"},{id:"step-2b-set-a-default-model-optional",content:"Step 2b: Set a default model (optional)"},{id:"step-3-extract-your-first-data",content:"Step 3: Extract your first data"},{id:"what-happened",content:"What happened?"},{id:"where-to-go-next",content:"Where to go next"}]};const h=[{depth:2,url:"#what-well-build",title:e.jsx(e.Fragment,{children:"What we'll build"})},{depth:2,url:"#prerequisites",title:e.jsx(e.Fragment,{children:"Prerequisites"})},{depth:2,url:"#step-1-install",title:e.jsx(e.Fragment,{children:"Step 1: Install"})},{depth:2,url:"#step-2-configure-your-api-key",title:e.jsx(e.Fragment,{children:"Step 2: Configure your API key"})},{depth:2,url:"#step-2b-set-a-default-model-optional",title:e.jsx(e.Fragment,{children:"Step 2b: Set a default model (optional)"})},{depth:2,url:"#step-3-extract-your-first-data",title:e.jsx(e.Fragment,{children:"Step 3: Extract your first data"})},{depth:2,url:"#what-happened",title:e.jsx(e.Fragment,{children:"What happened?"})},{depth:2,url:"#where-to-go-next",title:e.jsx(e.Fragment,{children:"Where to go next"})}];function t(s){const i={a:"a",code:"code",h2:"h2",li:"li",p:"p",pre:"pre",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(i.p,{children:"Extract structured data from any file in 3 commands. About 5 minutes."}),`
`,e.jsx(i.h2,{id:"what-well-build",children:"What we'll build"}),`
`,e.jsx(i.p,{children:"We will extract structured invoice data from a PDF using the CLI."}),`
...
`,e.jsx(i.p,{children:e.jsx(i.strong,{children:"Option C (one command, fully ready):"})}),`
...
`,e.jsx(i.h2,{id:"step-2b-set-a-default-model-optional",children:"Step 2b: Set a default model (optional)"}),`
`,e.jsxs(i.p,{children:["If you didn't use ",e.jsx(i.code,{children:"--default"})," above, set a default model explicitly:"]}),`
...
`,e.jsxs(i.p,{children:["For the text example, stdin input was loaded as an artifact, the LLM generated output, and Ajv validated it against your schema. The ",e.jsx(i.code,{children:"simple"})," strategy handled this in a single LLM call."]}),`
...
`,e.jsxs(i.table,{children:[e.jsx(i.thead,{children:e.jsxs(i.tr,{children:[e.jsx(i.th,{children:"Goal"}),e.jsx(i.th,{children:"Link"})]})}),e.jsxs(i.tbody,{children:[e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"Keep learning"}),e.jsx(i.td,{children:e.jsx(i.a,{href:"/docs/explanation/pipeline",children:"The Extraction Pipeline"})})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"Solve a real problem"}),e.jsx(i.td,{children:e.jsx(i.a,{href:"/docs/examples/extract-invoice",children:"Extract Invoice Data"})})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"Look up all CLI flags"}),e.jsx(i.td,{children:e.jsx(i.a,{href:"/docs/cli/extract",children:"CLI Reference"})})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"Use it in TypeScript"}),e.jsx(i.td,{children:e.jsx(i.a,{href:"/docs/sdk/installation",children:"TypeScript SDK"})})]}),e.jsxs(i.tr,{children:[e.jsx(i.td,{children:"Understand file parsing"}),e.jsx(i.td,{children:e.jsx(i.a,{href:"/docs/explanation/parsers",children:"Parsers"})})]})]})]})]})}function d(s={}){const{wrapper:i}=s.components||{};return i?e.jsx(i,{...s,children:e.jsx(t,{...s})}):t(s)}export{a as _markdown,d as default,l as frontmatter,r as structuredData,h as toc};
