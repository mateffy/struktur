import{j as e,aE as d,ax as a,ay as n,az as r,aC as l,aD as i}from"./main-BVKz-YcK.js";let c=`
...
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{children:"Use Case"}),e.jsx(t.th,{children:"Model"}),e.jsx(t.th,{children:"Cost (per 1M tokens)"}),e.jsx(t.th,{children:"Why"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.strong,{children:"Best quality"})}),e.jsx(t.td,{children:"Claude Sonnet 4.6"}),e.jsx(t.td,{children:"$3.00/$15.00"}),e.jsx(t.td,{children:"Best balance of quality and cost"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.strong,{children:"Latest frontier"})}),e.jsx(t.td,{children:"GPT-5.4"}),e.jsx(t.td,{children:"$2.50/$15.00"}),e.jsx(t.td,{children:"Native computer use, 1M context"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.strong,{children:"Large docs"})}),e.jsx(t.td,{children:"Gemini 3.1 Pro"}),e.jsx(t.td,{children:"$2.00/$12.00"}),e.jsx(t.td,{children:"2M token context"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:e.jsx(t.strong,{children:"Budget extraction"})}),e.jsx(t.td,{children:"Mistral Small 3.1"}),e.jsx(t.td,{children:"$0.20/$0.60"}),e.jsx(t.td,{children:"Cheapest capable"})]})]})]}),`
`,e.jsx(t.h3,{id:"openrouter-budget-picks",children:"OpenRouter budget picks"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{children:"Model"}),e.jsx(t.th,{children:"Cost (per 1M)"}),e.jsx(t.th,{children:"Best For"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Qwen3-235B-Thinking"}),e.jsx(t.td,{children:"$0.30/$1.20"}),e.jsx(t.td,{children:"Best reasoning at low cost"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"google/gemini-2.0-flash-lite"}),e.jsx(t.td,{children:"$0.25/$1.50"}),e.jsx(t.td,{children:"Fast, cheap, vision"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"mistralai/mistral-small-2603"}),e.jsx(t.td,{children:"$0.15/$0.60"}),e.jsx(t.td,{children:"Best price/quality"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"deepseek/deepseek-chat"}),e.jsx(t.td,{children:"$0.28/$1.10"}),e.jsx(t.td,{children:"Excellent reasoning"})]})]})]}),`
