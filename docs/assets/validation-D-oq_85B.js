import{j as e}from"./main-DmNcsfUg.js";let r=`
...
`,e.jsx(i.li,{children:"Validate the response with Ajv against the schema."}),`
`,e.jsx(i.li,{children:"If valid: return it."}),`
`,e.jsx(i.li,{children:"If invalid: serialize the Ajv error array into an XML block, append it to the message thread as a user message, go to step 1."}),`
...
`,e.jsxs(i.li,{children:[e.jsx(i.a,{href:"/docs/explanation/preprocessing/artifact-format",children:"The Artifact Format"})," — schema format"]}),`
