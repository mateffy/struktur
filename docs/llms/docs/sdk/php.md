...
$result = $client->extract(new ExtractionRequest(
    ...
    strict: false,              // true: require every required field (default: tolerate missing required)
...
try {
    ...
    // The extraction failed (model errors, provider failures)
    ...
    // $e->errors is a list<string> such as
