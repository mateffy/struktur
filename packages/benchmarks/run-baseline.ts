import { runBenchmark, saveReport, type BenchmarkCase } from "./src/index";
...
const kvCases = generateKeyValueCases(
  ...
  [
    {
      name: "company",
      values: ["Acme Corp", "Globex Inc", "Initech LLC", "Umbrella Corp", "Soylent Corp"],
    },
    {
      name: "date",
      values: ["2024-01-15", "2023-06-30", "2025-03-01", "2022-12-25", "2024-07-04"],
    },
...
const nestedCases: BenchmarkCase[] = [
  ...
  },
  {
    ...
    artifacts: [
      textArtifact(
        "Name: Central Bank\nAddress: 1000 Finance Blvd, New York, NY 10005\nContact: support@centralbank.com, Phone: 212-555-1000",
        "nested-3",
      ),
    ],
    source: { dataset: "nested-synthetic" },
  },
  {
    ...
    artifacts: [
      textArtifact(
        "Name: Green Fields Farm\nAddress: 789 Rural Route 7, Boulder, CO 80301\nContact: orders@greenfields.farm, Phone: 303-555-0789",
        "nested-4",
      ),
    ],
    source: { dataset: "nested-synthetic" },
...
const itemsCases: BenchmarkCase[] = [
  {
    ...
    gold: {
      ...
      items: [
        ...
        { name: "Gadget B", qty: 1, price: 24.5 },
  ...
  },
  {
    ...
    gold: {
      ...
      items: [
        ...
        { name: "Patch Cable", qty: 50, price: 2.5 },
      ],
    },
    artifacts: [
      textArtifact(
  ...
  },
  {
    ...
    gold: {
      ...
      items: [
        { name: "Bandages", qty: 100, price: 0.5 },
        { name: "Gloves", qty: 200, price: 0.15 },
        { name: "Syringes", qty: 50, price: 1.2 },
      ],
    },
    artifacts: [
      textArtifact(
