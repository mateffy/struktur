  ...
  buildings: [
    {
      ...
      units: [
        {
          label: "Erdgeschoss Verkaufsfläche",
          usages: ["retail"],
          area: 243.28,
          floor: 0,
          rent_per_m2: null,
          extra_costs_per_m2: null,
          features: [],
          images: [],
          floorplans: [],
        },
        ...
        {
          label: "1. Untergeschoss Nebenfläche",
          usages: ["storage"],
          area: 194.83,
          floor: -1,
          rent_per_m2: null,
  ...
  buildings: [
    {
      ...
      units: [
        {
          label: "3. Obergeschoss",
          usages: ["office"],
          area: 649,
          floor: 3,
          rent_per_m2: 16.0,
          extra_costs_per_m2: 3.5,
          features: ["open-rooms"],
          images: [],
          floorplans: [],
        },
  ...
  buildings: [
    {
      ...
      units: [
        {
          label: "Produktion und Lagerhalle 1",
          usages: ["production", "storage"],
          area: 5017,
          floor: 0,
          rent_per_m2: null,
          extra_costs_per_m2: null,
    ...
    },
    {
      ...
      units: [
        {
          label: "Produktion und Lagerhalle 2",
          usages: ["production", "storage"],
          area: 5447,
          floor: 0,
          rent_per_m2: null,
    ...
    },
    {
      ...
      units: [
        {
          label: "Produktion und Lagerhalle 3",
          usages: ["production", "storage"],
          area: 1279,
          floor: 0,
          rent_per_m2: null,
  ...
  buildings: [
    {
      ...
      units: [
        {
          label: "Factory Dock Ebene 5 - Fläche A",
          usages: ["production", "storage", "office"],
          area: 2408,
          floor: 5,
          rent_per_m2: null,
          extra_costs_per_m2: null,
        ...
        {
          label: "Factory Dock Ebene 5 - Fläche B",
          usages: ["production", "storage", "office"],
          area: 2500,
          floor: 5,
          rent_per_m2: null,
    ...
    },
    {
      ...
      units: [
        {
          label: "Office Dock Ebene 0 (Souterrain)",
          usages: ["office", "education", "storage"],
          area: 377,
          floor: 0,
          rent_per_m2: null,
          extra_costs_per_m2: null,
        ...
        {
          label: "Office Dock Ebene 1 (Erdgeschoss)",
          usages: ["office"],
          area: 610,
          floor: 1,
          rent_per_m2: null,
        ...
        {
          label: "Office Dock Ebene 6 (5.OG)",
          usages: ["office"],
          area: 469,
          floor: 6,
          rent_per_m2: null,
        ...
        {
          label: "Office Dock Ebene 8 (7.OG)",
          usages: ["office"],
          area: 266,
          floor: 8,
          rent_per_m2: null,
  ...
  buildings: [
    {
      ...
      units: [
        {
          label: "Geb. 139 Erdgeschoss Lager/Produktion",
          usages: ["production", "storage"],
          area: 355,
          floor: 0,
          rent_per_m2: 9.0,
          extra_costs_per_m2: null,
          features: ["high-ceilings", "ground-level-access", "rolling-gates"],
          images: [],
          floorplans: [],
        },
        {
          label: "Geb. 139 Erdgeschoss Lager/Produktion und Büro",
          usages: ["production", "storage", "office"],
          area: 683,
          floor: 0,
          rent_per_m2: 9.0,
        ...
        {
          label: "Geb. 139 1. Obergeschoss Büro",
          usages: ["office"],
          area: 204,
          floor: 1,
          rent_per_m2: 9.5,
    ...
    },
    {
      ...
      units: [
        {
          label: "Geb. 153 1. Obergeschoss Büro",
          usages: ["office"],
          area: 471,
          floor: 1,
          rent_per_m2: 13.5,
    ...
    },
    {
      ...
      units: [
        {
          label: "Geb. 153 TE Lager und Büro",
          usages: ["storage", "office"],
          area: 592,
          floor: 0,
          rent_per_m2: 8.5,
          extra_costs_per_m2: null,
  ...
  buildings: [
    {
      ...
      units: [
        {
          label: "EG Büroeinheit 1",
          usages: ["office"],
          area: 282,
          floor: 0,
          rent_per_m2: 24.0,
          extra_costs_per_m2: 3.6,
          features: ["high-ceilings", "air-conditioning"],
          images: [],
          floorplans: [],
        },
        {
          label: "EG Büroeinheit 2",
          usages: ["office"],
          area: 227,
          floor: 0,
          rent_per_m2: 24.0,
