...
`,i.jsxs(s.table,{children:[i.jsx(s.thead,{children:i.jsxs(s.tr,{children:[i.jsx(s.th,{children:"Field"}),i.jsx(s.th,{children:"Required"}),i.jsx(s.th,{children:"Description"})]})}),i.jsxs(s.tbody,{children:[i.jsxs(s.tr,{children:[i.jsx(s.td,{children:i.jsx(s.code,{children:"type"})}),i.jsx(s.td,{children:"Yes"}),i.jsxs(s.td,{children:["Must be ",i.jsx(s.code,{children:'"image"'})]})]}),i.jsxs(s.tr,{children:[i.jsx(s.td,{children:i.jsx(s.code,{children:"url"})}),i.jsx(s.td,{children:"No"}),i.jsxs(s.td,{children:["URL to image (mutually exclusive with ",i.jsx(s.code,{children:"base64"}),")"]})]}),i.jsxs(s.tr,{children:[i.jsx(s.td,{children:i.jsx(s.code,{children:"base64"})}),i.jsx(s.td,{children:"No"}),i.jsx(s.td,{children:"Base64-encoded image data (no data-URL prefix)"})]}),i.jsxs(s.tr,{children:[i.jsx(s.td,{children:i.jsx(s.code,{children:"text"})}),i.jsx(s.td,{children:"No"}),i.jsx(s.td,{children:"Alt text or OCR output"})]}),i.jsxs(s.tr,{children:[i.jsxs(s.td,{children:[i.jsx(s.code,{children:"x"}),", ",i.jsx(s.code,{children:"y"}),", ",i.jsx(s.code,{children:"width"}),", ",i.jsx(s.code,{children:"height"})]}),i.jsx(s.td,{children:"No"}),i.jsx(s.td,{children:"Optional spatial metadata (pixels)"})]}),i.jsxs(s.tr,{children:[i.jsx(s.td,{children:i.jsx(s.code,{children:"imageType"})}),i.jsx(s.td,{children:"No"}),i.jsxs(s.td,{children:[i.jsx(s.code,{children:'"embedded"'})," or ",i.jsx(s.code,{children:'"screenshot"'}),". Distinguishes images extracted from the document body from page renders. Omit for hand-crafted artifacts."]})]}),i.jsxs(s.tr,{children:[i.jsx(s.td,{children:i.jsx(s.code,{children:"virtualPath"})}),i.jsx(s.td,{children:"No"}),i.jsxs(s.td,{children:["Parser-assigned address for the image inside the agent's virtual filesystem, e.g. ",i.jsx(s.code,{children:"/images/page-1-image-2.png"}),". Set automatically by the PDF parser."]})]})]})]}),`
`,i.jsxs(s.p,{children:["Either ",i.jsx(s.code,{children:"url"})," or ",i.jsx(s.code,{children:"base64"})," must be present."]}),`
`,i.jsxs(s.p,{children:["The ",i.jsx(s.code,{children:"imageType"})," field is set automatically by the PDF parser: ",i.jsx(s.code,{children:'"embedded"'})," for images extracted from the PDF body (requires ",i.jsx(s.code,{children:"--images"}),"), ",i.jsx(s.code,{children:'"screenshot"'})," for full-page renders (requires ",i.jsx(s.code,{children:"--screenshots"}),") and for the generated image overview. The artifact viewer uses this field to filter and badge images independently."]}),`
`,i.jsxs(s.p,{children:[i.jsx(s.code,{children:"virtualPath"})," is the key the agent uses to address an image, and the key under which the image appears in the ",i.jsx(s.code,{children:"--images-output"})," map. It is also the caption drawn next to a thumbnail on the image overview, so the model can cite the path of the image it wants to inspect. When an artifact does not carry a ",i.jsx(s.code,{children:"virtualPath"})," (for example a hand-written artifact), the agent derives an equivalent path from the artifact id and page number."]}),`
...
`]})]})}function d(e={}){const{wrapper:s}=e.components||{};return s?i.jsx(s,{...e,children:i.jsx(n,{...e})}):n(e)}export{a as _markdown,d as default,h as frontmatter,l as structuredData,r as toc};
