...
`,e.jsxs(i.ul,{children:[`
`,e.jsxs(i.li,{children:[e.jsx(i.a,{href:"/docs/explanation/document-parsing",children:"Document Parsing"})," — how to get input into Struktur and how files are converted to artifacts"]}),`
`,e.jsxs(i.li,{children:[e.jsx(i.a,{href:"/docs/sdk/parse",children:"parse()"})," — the SDK API"]}),`
