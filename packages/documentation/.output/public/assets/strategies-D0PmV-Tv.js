import{j as e,ay as o,az as a,aA as n,at as r,aw as l,ax as i}from"./main-Bec1B5yw.js";let c=`
...
`,e.jsx(o,{type:"info",children:e.jsxs(t.p,{children:[e.jsx(t.strong,{children:"The Agent strategy is the default."})," You don't need to specify ",e.jsx(t.code,{children:"--strategy agent"})," — it's used automatically when you run ",e.jsx(t.code,{children:"struktur extract"}),"."]})}),`
...
`]}),`
`,e.jsx(t.h3,{id:"model-compatibility",children:"Model compatibility"}),`
`,e.jsx(t.p,{children:"The agent requires models that support tool/function calling:"}),`
`,e.jsxs(t.table,{children:[e.jsx(t.thead,{children:e.jsxs(t.tr,{children:[e.jsx(t.th,{children:"Provider"}),e.jsx(t.th,{children:"Compatible Models"})]})}),e.jsxs(t.tbody,{children:[e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Anthropic"}),e.jsx(t.td,{children:"Claude 3.5 Sonnet, Claude 3 Opus, Claude 3 Haiku"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"OpenAI"}),e.jsx(t.td,{children:"GPT-4o, GPT-4 Turbo, GPT-4, GPT-3.5 Turbo"})]}),e.jsxs(t.tr,{children:[e.jsx(t.td,{children:"Google"}),e.jsx(t.td,{children:"Gemini 1.5 Pro, Gemini 1.5 Flash"})]})]})]}),`
`,e.jsx(o,{type:"warn",children:e.jsx(t.p,{children:"Some models claim tool support but don't work well with the agent. Avoid: GPT-4o-mini (inconsistent tool calling), older GPT-3.5 models, models without native function calling."})}),`
...
`,e.jsx(o,{type:"info",children:e.jsx(t.p,{children:`Strategies with "AutoMerge" in the name use schema-aware merge and deduplication. They're ideal for extracting arrays that may have duplicates across chunks.`})}),`
