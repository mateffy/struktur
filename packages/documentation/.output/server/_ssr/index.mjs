...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B-rCtH27.mjs");
...
async function loadEntries() {
  const routerEntry = await import("./router-B6knFJjm.mjs").then((n2) => n2.a5);
