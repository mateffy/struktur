...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-uPfc9NW5.mjs");
...
const manifest = { "3dffc64eabe29fc8f5f4021f5e1cdf4bfea9319ffba3a59848ead9dcd2fa0308": {
  ...
  importer: () => import("./_-Cr_J2uyL.mjs")
} };
...
async function loadEntries() {
  const routerEntry = await import("./router-D2LXstVC.mjs").then((n2) => n2.a4);
