...
$result = $client->extract(new ExtractionRequest(
    ...
    schema: $schema,
    model: 'openai/gpt-4o',
    strategy: 'simple',         // optional, default: auto
    screenshots: true,          // capture screenshots of each page
...
For Docker deployments, include both PHP and Node.js. Refer to the [Docker guide](/docs/cli/docker) for the full Dockerfile and docker-compose example.
