 ...
 */
export const buildSchemaFromParsedFields = (fields: ParsedField[]): Record<string, unknown> => {
  if (fields.length === 0) {
 ...
 */
export const buildSchemaFromFields = (fields: string): Record<string, unknown> =>
