...
function calculateChunks(artifacts: Artifact[], settings: ChunkingSettings): Chunk[] {
  const chunks: Chunk[] = [];
    ...
    artifacts.forEach((artifact, aIdx) => {
      artifact.contents.forEach((content, cIdx) => {
        if (content.page !== undefined) {
          ...
          const chunk =
            chunks.find((c) => c.artifactIdx === aIdx && c.contentIdx <= cIdx) ||
  ...
  return (
    <div className="w-20 flex-shrink-0 bg-[#ede5d8] border border-[#d4c8b8] rounded-lg p-2 flex flex-col gap-3 max-h-[calc(100vh-120px)] overflow-y-auto sticky top-4 self-start">
      ...
      {pagesByChunk.map((chunkGroup) => {
        ...
        return (
          <div key={`chunk-group-${chunkGroup.chunkId}`} className="flex flex-col gap-1">
            {hasValidChunk && (
            ...
            <div
              ...
              style={{
                backgroundColor: hasValidChunk ? getChunkColor(chunkGroup.chunkId) : "transparent",
              }}
            >
                  ...
                  <CardHeader className="pb-0 pt-0 px-0">
                    <div className="flex items-center justify-between">
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-[#a0926f] truncate mt-0.5">{artifact.id}</p>
                      </div>
                        ...
                        <div key={contentKey} className="relative">
                            ...
                            <div className="relative py-3 my-1">
                              ...
                              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex items-center gap-2 bg-[#ede5d8] px-3 py-1">
                                <div
                                  ...
                                  style={{
                                    backgroundColor: getChunkColor(contentChunk.id),
                                  }}
                                />
                                <span
                          ...
                          >
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              {content.media?.some((m) => m.imageType === "screenshot") && (
                            ...
                            {content.media?.some((m) => m.imageType === "embedded") && (
      ...
      <div className="flex flex-col items-center justify-center h-64 text-[#a0926f]">
        {isParsing ? (
          <>
            ...
            <p className="text-sm font-medium text-[#7a5c3a]">Parsing files...</p>
          ...
          <>
            ...
            <p className="text-xs mt-1 opacity-70">Upload files and click Parse to see artifacts</p>
          </>
        )}
      </div>
    );
