    ...
    <div className="space-y-4">
      ...
      >
        <div className="flex items-center space-x-2">
          ...
          />
          <Label htmlFor="fields" className="font-normal text-[#3d2b15] cursor-pointer">Fields shorthand</Label>
        </div>
        <div className="flex items-center space-x-2">
          <RadioGroupItem 
            value="json" 
            ...
            className="border-[#d4c8b8] text-[#7a5c3a] data-[state=checked]:border-[#7a5c3a] data-[state=checked]:bg-[#7a5c3a]"
          />
          <Label htmlFor="json" className="font-normal text-[#3d2b15] cursor-pointer">JSON Schema</Label>
        </div>
      </RadioGroup>

      {mode === 'fields' && (
        <div className="space-y-2 pt-2">
          <Label htmlFor="fields-input" className="text-[#3d2b15]">Field definitions</Label>
          <Input
            id="fields-input"
      ...
      {mode === 'json' && (
        <div className="space-y-2 pt-2">
          <Label htmlFor="json-input" className="text-[#3d2b15]">JSON Schema</Label>
          <Textarea
            id="json-input"
