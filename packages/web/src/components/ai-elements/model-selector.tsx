...
export const ModelSelectorEmpty = ({
	...
	<CommandEmpty
		className={cn("py-6 text-center text-sm text-[#a0926f]", className)}
		{...props}
	/>
);
...
export const ModelSelectorShortcut = ({
	...
	<CommandShortcut
		className={cn("ml-auto text-xs text-[#a0926f]", className)}
		{...props}
	/>
);
...
export const ModelSelectorSeparator = ({
	...
	<CommandSeparator
		className={cn("h-px bg-[#d4c8b8] my-1", className)}
		{...props}
	/>
);
