...
export const PROVIDER_CONFIGS: Record<ProviderId, ProviderConfig> = {
  openai: {
    ...
    description: 'Access GPT-4, GPT-3.5, and other OpenAI models. API keys start with "sk-".',
  ...
  google: {
    ...
    description: "Access Gemini models. API keys are alphanumeric strings.",
    recommendedPermissions: [
  ...
  openrouter: {
    ...
    description: "Access models from multiple providers through a unified API.",
    recommendedPermissions: [
      "Set spending limits",
